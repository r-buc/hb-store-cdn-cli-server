...
declare type SeekChunk = (offset: number, whence?: number) => Promise<Buffer>;
declare type CustomSeek = {
    seekChunk: SeekChunk;
    destroyAll?: () => void;
};
declare type ExtractOptions = CustomSeek & {
    /**
     * @default true
     */
...
declare type Ps4PkgInfo = {
    paramSfo?: Ps4PkgParamSfo;
    icon0Raw?: Buffer;
    icon0?: string;
};

declare type Options = Pick<ExtractOptions, 'generateIcon0' | 'generateParamSfo'> & {
    /**
     * base64
     * @default false
     */
...
declare const getPs4PkgInfo: (pkgFileUrl: string, options?: Options | undefined) => Promise<Ps4PkgInfo | undefined>;

export { Ps4PkgAppType, Ps4PkgCategory, Ps4PkgParamSfo, getPs4PkgInfo };
